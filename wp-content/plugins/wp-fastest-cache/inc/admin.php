							...
							<?php
								...
								if(in_array(get_bloginfo('language'), $tester_arr_preload) || in_array(str_replace("www.", "", $_SERVER["HTTP_HOST"]), $tester_arr_preload)){
									...
									<div class="questionCon">
										...
										<div class="inputCon"><input type="checkbox" <?php echo $wpFastestCachePreload; ?> id="wpFastestCachePreload" name="wpFastestCachePreload"><label for="wpFastestCachePreload">Create the cache of all the site automatically</label> <b style="color:red;">(BETA)</b></div>
